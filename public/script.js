...
async function getWeather() {
  ...
  try {
    ...
    document.getElementById("wHumidity").innerText = data.humidity;
    document.getElementById("wWind").innerText = data.windKmh;
    document.getElementById("wDesc").innerText = data.description;
    
    if (data.icon) {
      document.getElementById("wIcon").src = `https://openweathermap.org/img/wn/${data.icon}@2x.png`;
